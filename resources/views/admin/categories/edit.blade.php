...
<div class="max-w-lg">
    <div class="mb-5">
        ...
        <h1 class="text-xl font-bold text-slate-800 mt-2">Edit Kategori</h1>
    </div>
        ...
        <form action="{{ route('admin.categories.update', $category) }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="3"
                          class="w-full px-3.5 py-2.5 border border-slate-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none">{{ old('description', $category->description) }}</textarea>
            </div>
